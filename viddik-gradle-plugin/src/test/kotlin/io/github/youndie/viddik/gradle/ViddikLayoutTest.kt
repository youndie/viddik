...
class ViddikLayoutTest {
    ...
    fun `a KMP consumer takes the base coordinates and a plain jvm one the platform artifacts`() {
        ...
        assertEquals("io.github.youndie.viddik:viddik-annotations", multiplatform.annotations)
        assertEquals("io.github.youndie.viddik:viddik-testing-core", multiplatform.testingCore)
        ...
        assertEquals("io.github.youndie.viddik:viddik-annotations-desktop", jvm.annotations)
        assertEquals("io.github.youndie.viddik:viddik-testing-core-jvm", jvm.testingCore)

        // The processor is a plain jvm module either way.
        assertEquals("io.github.youndie.viddik:viddik-processor", multiplatform.processor)
        assertEquals("io.github.youndie.viddik:viddik-processor", jvm.processor)
    }
