    ...
    internal companion object {
        ...
        fun forMultiplatform(
            ...
            ViddikLayout(
                ...
                coordinates =
                    ViddikCoordinates(
                        annotations = "ru.workinprogress:viddik-annotations",
                        testingCore = "ru.workinprogress:viddik-testing-core",
                    ),
            )
        ...
        fun forJvm(): ViddikLayout =
            ViddikLayout(
                ...
                coordinates =
                    ViddikCoordinates(
                        annotations = "ru.workinprogress:viddik-annotations-desktop",
                        testingCore = "ru.workinprogress:viddik-testing-core-jvm",
                    ),
            )
...
internal data class ViddikCoordinates(
    ...
    val processor: String get() = "ru.workinprogress:viddik-processor"
}
